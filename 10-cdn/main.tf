resource "aws_cloudfront_distribution" "web_cdn" {
  origin {
    domain_name              =  "web-${var.environment}.${var.zone_name}"#web-dev.expensesnote.site
  ...
  aliases = ["web-${var.common_tags.Component}.${var.zone_name}"]#web-cdn.expensesnote.site
...
module "records" {
  ...
  records = [
    {
      name    = "web-cdn" #web-cdn.expensesnote.site
      type    = "A"
